...
import { containBoxSize, downsizeImage, isGifAnimated } from "./utils/assets/assets.mjs";
import { getEmbedInfo } from "./utils/embeds/embeds.mjs";
import { cleanupText, isRightToLeftLanguage, truncateStringWithEllipsis } from "./utils/text/text.mjs";
