...
var DrawStyleCloud_exports = {};
__export(DrawStyleCloud_exports, {
  DrawStyleCloud: () => DrawStyleCloud
});
module.exports = __toCommonJS(DrawStyleCloud_exports);
...
const DrawStyleCloud = React.memo(function StyleCloud({
  ...
  const path = (0, import_cloudOutline.inkyCloudSvgPath)(w, h, id, size);
...
//# sourceMappingURL=DrawStyleCloud.js.map
