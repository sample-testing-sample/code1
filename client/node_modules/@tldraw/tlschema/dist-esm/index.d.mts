...
/** @public */
export declare const arrowShapeMigrations: TLShapePropsMigrations;
...
/** @public */
export declare const bookmarkShapeMigrations: TLShapePropsMigrations;
...
declare const colors: readonly ["black", "grey", "light-violet", "violet", "blue", "light-blue", "yellow", "orange", "green", "light-green", "light-red", "red", "white"];
 ...
 *
 * @public */
export declare function createAssetValidator<Type extends string, Props extends JsonObject>(type: Type, props: T.Validator<Props>): T.ObjectValidator<{ [P in "id" | "meta" | "typeName" | (undefined extends Props ? never : "props") | (undefined extends Type ? never : "type")]: {
        id: TLAssetId;
        meta: JsonObject;
        props: Props;
        type: Type;
 ...
 * @public
 */
export declare function createShapePropsMigrationIds<S extends string, T extends Record<string, number>>(shapeType: S, ids: T): {
 ...
 * @public
 */
export declare function createShapePropsMigrationSequence(migrations: TLShapePropsMigrations): TLShapePropsMigrations;
 ...
 *
 * @public */
export declare function createTLSchema({ shapes, migrations, }?: {
...
/** @public */
export declare const drawShapeMigrations: TLShapePropsMigrations;
...
/** @public */
export declare const embedShapeMigrations: TLShapePropsMigrations;
...
/** @public */
export declare const frameShapeMigrations: TLShapePropsMigrations;
...
/** @public */
export declare const geoShapeMigrations: TLShapePropsMigrations;
...
/** @public */
export declare const groupShapeMigrations: TLShapePropsMigrations;

/** @public */
export declare const groupShapeProps: ShapeProps<TLGroupShape>;

/** @public */
export declare const highlightShapeMigrations: TLShapePropsMigrations;
...
/** @public */
export declare const imageShapeMigrations: TLShapePropsMigrations;
...
/** @public */
export declare const lineShapeMigrations: TLShapePropsMigrations;
...
declare const NO_DOWN_MIGRATION: "none";

/** @public */
export declare const noteShapeMigrations: TLShapePropsMigrations;
...
declare const RETIRED_DOWN_MIGRATION: "retired";
...
/** @public */
export declare const textShapeMigrations: TLShapePropsMigrations;
 ...
 *
 * @public */
declare const TL_HANDLE_TYPES: Set<"clone" | "create" | "vertex" | "virtual">;
 ...
 * @public
 */
export declare type TLShapePropsMigrations = {
    sequence: Array<{
...
/** @public */
export declare const videoShapeMigrations: TLShapePropsMigrations;
