...
declare class __EffectScheduler__<Result> {
 ...
 * @public
 */
export declare const EffectScheduler: typeof __EffectScheduler__;

/** @public */
export declare type EffectScheduler<Result> = __EffectScheduler__<Result>;
...
declare type WithDiff<Value, Diff> = {
    diff: Diff;
    value: Value;
};
