...
function DefaultCanvas({ className }) {
  ...
  (0, import_state.useQuickReactor)(
    ...
    function positionLayersWhenCameraMoves() {
      ...
      if (rMemoizedStuff.current.allowTextOutline && z < import_constants.TEXT_SHADOW_LOD !== rMemoizedStuff.current.lodDisableTextOutline) {
        const lodDisableTextOutline = z < import_constants.TEXT_SHADOW_LOD;
        container.style.setProperty(
          "--tl-text-outline",
          lodDisableTextOutline ? "none" : `0 var(--b) 0 var(--color-background), 0 var(--a) 0 var(--color-background),
...
function HandlesWrapperInner({ shapeId }) {
  ...
  const handles = (0, import_state.useValue)(
    ...
    () => {
      ...
      if (!handles2)
        return null;
      const minDistBetweenVirtualHandlesAndRegularHandles = (isCoarse ? import_constants.COARSE_HANDLE_RADIUS : import_constants.HANDLE_RADIUS) / zoomLevel * 2;
