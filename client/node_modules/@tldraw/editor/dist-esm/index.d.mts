...
declare type ExtractArgs<Fn> = Parameters<Extract<Fn, (...args: any[]) => any>>;
...
declare class HistoryManager<CTX extends {
    ...
    getNumUndos(): number;
    getNumRedos(): number;
    createCommand: <Name extends string, Constructor extends CommandFn<any>>(name: Name, constructor: Constructor, handle: TLCommandHandler<ExtractData<Constructor>>) => (...args: ExtractArgs<Constructor>) => CTX;
    batch: (fn: () => void) => this;
